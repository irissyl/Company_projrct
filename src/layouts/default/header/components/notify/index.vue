...
<script lang="ts">
  ...
  import DetailModal from '/@/views/message/mynews/DetailModal.vue';
  import DynamicNotice from '/@/views/message/mynews/DynamicNotice.vue';
  import { useModal } from '/@/components/Modal'
  import { useDesign } from '/@/hooks/web/useDesign';
  import { useGlobSetting } from '/@/hooks/setting'
  import { useUserStore } from '/@/store/modules/user';
  import { connectWebSocket, onWebSocket } from '/@/hooks/web/useWebSocket'
  import { readAllMsg } from '/@/views/message/mynews/mynews.api'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      function initWebSocket() {
        let userId = unref(userStore.getUserInfo).userId
        let token=getToken();
