...
enum Api {
  ...
  queryTreeList = '/sys/sysDepart/queryDepartTreeList',
  loadTreeData = '/sys/category/loadTreeData',
  loadAllTreeByCode = '/sys/category/loadAllTreeByCode',
 ...
 * 分类字典树控件 加载全部节点节点
 */
export const loadAllTreeByCode = (params?) =>{
  return defHttp.get({ url: Api.loadAllTreeByCode, params });
}
